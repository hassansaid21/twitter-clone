...
export default function ProfileHeader({ username }: ProfileHeaderProps) {
  return (
    <>
      ...
      <div className="px-4 py-1 flex flex-col justify-center gap-4">
        <div>
          <h2 className="font-bold text-3xl text-white">Hassan Said</h2>
          <span className="text-textGray text-sm">@hassansaid</span>
        </div>
        <div className="text-lg">
          a software engineer with expertise in react, tailwind, next.js and angular
        </div>
